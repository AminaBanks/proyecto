...
*/
  ...
  class bm_categories {
    ...
    function execute() {
      ...
      //$OSCOM_CategoryTree->setSpacerString('&nbsp;&nbsp;', 1); //reemplazar esta linea a la linea de abao*/
      $OSCOM_CategoryTree->setSpacerString('<i class="glyphicon glyphicon-arrow-right"></i>', 1);
