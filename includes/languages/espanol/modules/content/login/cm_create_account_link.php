...
*/
  ...
  define('MODULE_CONTENT_CREATE_ACCOUNT_LINK_TITLE', 'Create enlace a una cuenta');
  define('MODULE_CONTENT_CREATE_ACCOUNT_LINK_DESCRIPTION', 'Mostrar crear cuenta en pagina de subscripción');

  define('MODULE_CONTENT_LOGIN_HEADING_NEW_CUSTOMER', 'Nuevo Socio');
