...
define ('LANGUAGE_1','Catal‡ (ca)');
define ('LANGUAGE_2','EspaÒol (es)');
define ('LANGUAGE_3','English (en)');
define ('LANGUAGE_4','FranÁais (fr)');
...
define('TEXT_RESULT_PAGE', 'Pàgines de resultats:');
...
define('TEXT_VIEW_GRID', ' QuadrÌcula');
