...
define ('MESSAGE_CLIENT','En menys de 24 hores rebr‡s un correu electrÚnic amb les claus díaccÈs al ComerÁ Solidari de PROIDE.<br>
Gr‡cies.<br> 
FundaciÛ PROIDE
');
define('MESSAGE_SUBJECT_CREATE_ACOUNT', 'Sol∑licitud ComerÁ Solidari PROIDE');
define('IMAGE_BUTTON_EXIT', 'sortir');
define('MAIL_ERROR', 'AdreÁa de correu incorrecte ');
?>
