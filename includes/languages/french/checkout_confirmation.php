...
define('HEADING_TITLE', 'Confirmation de la commande.');

define('HEADING_SHIPPING_INFORMATION', 'Informations sur la livraison');
...
define('HEADING_BILLING_INFORMATION', 'Informations de facturation');
define('HEADING_BILLING_ADDRESS', 'Adresse de facturation');
define('HEADING_PAYMENT_METHOD', 'Mode de paiement');
define('HEADING_PAYMENT_INFORMATION', 'Informations de paiement');
