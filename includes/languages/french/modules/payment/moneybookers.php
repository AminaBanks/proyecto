...
*/
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_TEXT_TITLE', 'Moneybookers - Module principal');
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_RETURN_TEXT', 'Continuer et retournez à ' . STORE_NAME);
  define('MODULE_PAYMENT_MONEYBOOKERS_LANGUAGE_CODE', 'EN');

  define('MB_ACTIVATION_TITLE', 'Activation des comptes Moneybookers');
  define('MB_ACTIVATION_ACCOUNT_TITLE', 'Vérification du compte');
