...
define('HEADING_TITLE', 'Informations sur la livraison.');

define('TABLE_HEADING_SHIPPING_ADDRESS', 'Adresse d\'expédition');
define('TEXT_SELECTED_SHIPPING_DESTINATION', 'Veuillez choisir dans votre carnet d\'adresses l\'adresse où vous souhaitez que les articles soient livrés.');
define('TITLE_SHIPPING_ADDRESS', 'Adresse d\'expédition :');

define('TABLE_HEADING_ADDRESS_BOOK_ENTRIES', 'Entrées du carnet d\'adresses');
define('TEXT_SELECT_OTHER_SHIPPING_DESTINATION', 'Veuillez choisir l\'adresse d\'expédition si les articles de cette commande doivent être livrés à une autre adresse.');
