...
<tr class="dataTableHeadingRow">
   ...
   <?php
 $check_address_query = tep_db_query("SELECT p.products_quantity, pd.products_name from products p inner join products_description pd  where p.products_id=pd.products_id and p.products_quantity < 1");
