...
?>
 ...
 <div class="buttonSet col-xs-12">
  ...
  <div class="text-right col-xs-6"> <a href="checkout_payment.php" id="list" class="btn btn-default btn-sm"><?php echo(IMAGE_BUTTON_CHECKOUT2);?><span class="glyphicon glyphicon-chevron-right"></span></a>
